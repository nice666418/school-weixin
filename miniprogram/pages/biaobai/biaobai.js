...
Page({
  ...
  data: {
    ...
    device: device,
    devices: "话筒",
    multiArray: [years, months, days,device],
    multiIndex: [0, 0, 0, 0],
    to:"新安101话筒"
  },
  bindMultiPickerChange: function (e) {
    ...
    this.setData({
      to: data.multiArray[0][data.multiIndex[0]]+data.multiArray[1][data.multiIndex[1]]+data.multiArray[2][data.multiIndex[2]]+data.multiArray[3][data.multiIndex[3]]
    })
  },
